...
Hi, I'm Bennett from the band [Bobtail Yearlings](https://www.bobtailyearlings.com). We're looking for someone with an entrepreneurial spirit, who recognizes the opportunity we're presenting with *Bobtail Method*, our songwriting book. I wrote the manuscript you see here as a proof of concept to win over the indie labels. I never bothered to publish it on my own— not just because a songwriting book by a nobody is completely worthless, but because Bobtail Method really works best as an interactive tutorial and compositional tool.

It should be obvious that I won't be a nobody for much longer. So if you're interested in partnering with us to turn Bobtail Method into an online app for both web and native platforms, please get in touch!
                    `}
                </Markdown>
                <ContactEmail />
                <Markdown>
