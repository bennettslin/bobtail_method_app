...
I just figured that, if you're a label, then surely this is what you'd rather see a band do. Obviously, bands should innovate; building a fanbase is just an option you offer to those who can't. Right? Well… no. The indie labels still insisted that I build a fanbase on my own. But I didn't see anything wrong with my reasoning, so I just assumed I hadn't met the threshold. If I stuck with my strategy of trying to advance the art form, then eventually I'd meet it, however many years it took.
